...
public class WeekSpendingActivity extends AppCompatActivity {
    ...
    private WeekSpendingAdopter weekSpendingAdopter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weekSpendingAdopter = new WeekSpendingAdopter(WeekSpendingActivity.this,myDataList);
        recyclerView.setAdapter(weekSpendingAdopter);
    ...
    private void readMonthSpendingItems() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                weekSpendingAdopter.notifyDataSetChanged();
