...
public class TodayItemAdopter extends RecyclerView.Adapter<TodayItemAdopter.ViewHolder> {
    ...
    public TodayItemAdopter(Context mContext, List<Data> myDataList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new TodayItemAdopter.ViewHolder(view);
    }
