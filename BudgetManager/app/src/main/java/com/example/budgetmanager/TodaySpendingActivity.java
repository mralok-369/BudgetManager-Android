...
public class TodaySpendingActivity extends AppCompatActivity {
    ...
    private TodayItemAdopter todayItemAdopter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        todayItemAdopter = new TodayItemAdopter(TodaySpendingActivity.this, myDataList);
        recyclerView.setAdapter(todayItemAdopter);
    ...
    private void readItems() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                todayItemAdopter.notifyDataSetChanged();
